import { List,useRedirect,useNotify,useRefresh, useRecordContext, ReferenceField, TextField, Show, SimpleShowLayout,
    NumberField, ArrayField, ImageField, Datagrid, Identifier } from 'react-admin';
import PDFButton from '../../src/PDFButton';
...
export const CartList = () => {
    const redirect = useRedirect();
     // Handle row click
     const handleRowClick = (id: Identifier | undefined, resource: string | undefined, record: any) => {
        if (id && record.email) {
            // Store the cart ID and email in localStorage
    ...
    return (
        <List>
            <Datagrid rowClick={(id, resource, record) => handleRowClick(id, resource, record)}>
